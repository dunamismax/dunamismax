...
Florida-based builder focused on small, self-hosted software and straightforward tooling.

Python · Go · C · PostgreSQL · Docker
...
- Keep projects self-hostable when that preserves control and keeps maintenance understandable.
