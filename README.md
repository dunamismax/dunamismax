...
- [callrift](https://github.com/dunamismax/callrift) - self-hosted incident command platform with public status pages, a responder console, and an optional built-in audio bridge.
...
- [myliferpg](https://github.com/dunamismax/myliferpg) - gamified habit engine with mood-habit correlation, adaptive difficulty, and an RPG layer designed to fade into analytics.
