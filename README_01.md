...
Most of the work lives in **Go** and **Rust**, with **TypeScript** on the browser-facing side when a product needs one. Local-first, operator-friendly, relational data, single-binary where possible.
...
[tech-stacks](./tech-stacks/README.md) — opinionated reference docs for the stack.