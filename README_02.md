...
Primary stack: **Go**, **Rust**, and **TypeScript** when the browser is part of the product. I bias toward local-first systems, explicit data models, relational storage, and boring infrastructure that still works at 2am.
